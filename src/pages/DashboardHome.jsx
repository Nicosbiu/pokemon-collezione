            ...
            <div className="min-h-screen bg-gradient-to-br from-violet-900 to-black pt-32 p-8">
                <div className="max-w-7xl mx-auto">
                    <div className="backdrop-blur-xl bg-white/[0.08] border border-white/[0.12] 
                        ...
                        <p className="text-white/70 mt-4">Caricamento dei dati...</p>
                    </div>
                </div>
            </div>
        );
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="backdrop-blur-xl bg-white/[0.08] border border-white/[0.12] 
                    ...
                    <h1 className="text-4xl font-bold text-white mb-2">
                        Bentornato, {currentUser?.displayName || currentUser?.email?.split('@')[0]}! 👋
                    </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <StatCard
                        title="Collezioni totali"
                        value={collections.length}
                        subtitle="Collezioni create"
                    ...
                    <StatCard
                        ...
                        subtitle="Carte in collezione"
                        gradientFrom="from-green-500/30"
                        gradientTo="to-emerald-500/30"
                    />
                    <StatCard
                        title="Completamento collezioni"
                        value="0%"
                        subtitle="Percentuale di completamento"
                    ...
                    <StatCard
                        ...
                        value="0"
                        subtitle="Carte aggiunte questa settimana"
                ...
                <div className="backdrop-blur-xl bg-white/[0.08] border border-white/[0.12] 
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                        ...
                        >
                            <h3 className="text-white font-semibold mb-2">Vai alle collezioni</h3>
                            <p className="text-white/70 text-sm">Gestisci le tue collezioni</p>
                        </Link>

                        <div className="backdrop-blur-xl bg-white/[0.08] border border-white/[0.12] 
                           rounded-xl p-6 opacity-50 text-center">
                            <h3 className="text-white font-semibold mb-2">Aggiungi una carta</h3>
                            <p className="text-white/70 text-sm">Coming soon...</p>
                        </div>

                        <div className="backdrop-blur-xl bg-white/[0.08] border border-white/[0.12] 
                           rounded-xl p-6 opacity-50 text-center">
                            <h3 className="text-white font-semibold mb-2">Guarda statistiche</h3>
                            <p className="text-white/70 text-sm">Coming soon...</p>
                        </div>
                    </div>
                </div>
